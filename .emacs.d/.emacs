...
(custom-set-variables
 ...
 '(safe-local-variable-values (quote ((TeX-PDF-mode . t) (TeX-master . "master") (eval progn (c-set-offset (quote innamespace) (quote 0)) (c-set-offset (quote inline-open) (quote 0)))))))
(custom-set-faces
